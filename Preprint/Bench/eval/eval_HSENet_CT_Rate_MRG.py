...
class ModelArguments:
    ...
    resume_mllm_weights: str = field(default="/home/ynwang/Yanzhaoshi/HSENet/Model/trained_vlm_for_ct_rate/pytorch_model.bin")
    ...
    file_name: str = field(default="eval_caption_dualvits_spatialpacker.csv", metadata={"help": ""})
...
def main():
    ...
    # load pretrained stage2 weights
